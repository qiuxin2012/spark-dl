...
import com.intel.analytics.sparkdl.nn.{Sequential, SpatialSubtractiveNormalization}
...
class SpatialSubtractiveNormalizationSpec extends FlatSpec with BeforeAndAfter with Matchers {
  ...
  "A SpatialSubtractiveNormalization with specific kernel" should "generate correct output and grad" in {
    val seed = 100
    RNG.setSeed(seed)
