...
import com.intel.analytics.sparkdl.nn.{Sequential, SpatialDivisiveNormalization}
...
class SpatialDivisiveNormalizationSpec extends FlatSpec with BeforeAndAfter with Matchers {
  ...
  "A SpatialDivisiveNormalization with specific kernel" should "generate correct output and grad" in {
    val seed = 100
    RNG.setSeed(seed)
