...
import com.intel.analytics.sparkdl.nn.{Sequential, SpatialContrastiveNormalization}
...
class SpatialContrastiveNormalizationSpec extends FlatSpec with BeforeAndAfter with Matchers {
  ...
  "A SpatialContrastiveNormalization with specific kernel" should "generate correct output and grad" in {
    val seed = 100
    RNG.setSeed(seed)
  ...
  "A SpatialContrastiveNormalization 3D input with specific kernel" should "generate correct output and grad" in {
    val seed = 100
    RNG.setSeed(seed)
